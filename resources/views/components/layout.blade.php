...
<head>
  ...
  <title>PunkDate | A Dedicated Punk Dating Site</title>
</head>
...
<body class="mb-48">
  ...
  <main>
    {{-- LAYOUT COMPONENT, USE SLOT TO OUTPUT VIEWS --}}
  ...
  <footer
    ...
    <a href="create.html" class="absolute top-1/3 right-10 bg-black text-white py-2 px-5">Post Profile</a>
  </footer>
</body>
